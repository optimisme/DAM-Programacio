...
public class Main {
    public static void main(String[] args) {
        ...
        Object[] result = mesLlarg(arrayExtrany);
        System.out.printf("La longitud de l'element més llarg: %d\n", result[0]);
        System.out.printf("L'element més llarg: %s\n", Arrays.toString((double[]) result[1]));
    }

    public static Object[] mesLlarg(double[][] array) {
        int maxLength = 0;
        double[] longestElement = null;
        ...
        return new Object[]{maxLength, longestElement};
    }
}
