...
public class Main {
    public static void main(String[] args) {
        ...
        Object[] result = sumesArray(arrayExtrany);
        System.out.println("Suma de tots els valors de cada array interior: " + Arrays.toString((double[]) result[0]));
        System.out.println("Suma total de tots els elements: " + result[1]);
    }

    public static Object[] sumesArray(double[][] array) {
        double[] sumes = new double[array.length];
        double sumaTotal = 0;
        ...
        return new Object[]{sumes, sumaTotal};
    }
}
