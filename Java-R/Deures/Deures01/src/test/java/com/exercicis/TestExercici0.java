...
class TestExercici0 {
    ...
    @Test
    public void testValidarNom(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testValidarEdat(TestInfo testInfo) throws Exception {
        try {
            ArrayList<Object[]> tests = new ArrayList<>();
    ...
    @Test
    public void testValidarFactors(TestInfo testInfo) throws Exception {
        try {
            ArrayList<Object[]> tests = new ArrayList<>();
    ...
    @Test
    public void testValidarDescompte(TestInfo testInfo) throws Exception {
        try {
            ArrayList<Object[]> tests = new ArrayList<>();
    ...
    @Test
    public void testValidarTipusOperacio(TestInfo testInfo) throws Exception {
        try {
            ArrayList<Object[]> tests = new ArrayList<>();
    ...
    @Test
    public void testValidarClients(TestInfo testInfo) throws Exception {
        try {
            ArrayList<Object[]> tests = new ArrayList<>();
    ...
    @Test
    public void testIsAllDigits(TestInfo testInfo) throws Exception {
        try {
            ArrayList<Object[]> tests = new ArrayList<>();
    ...
    @Test
    public void testValidarData(TestInfo testInfo) throws Exception {
        try {
            ArrayList<Object[]> tests = new ArrayList<>();
    ...
    @Test
    public void testValidarPreu(TestInfo testInfo) throws Exception {
        try {
            ArrayList<Object[]> tests = new ArrayList<>();
    ...
    @Test
    public void testGeneraClauClient(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testAfegirClient(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testModificarClient(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testEsborrarClient(TestInfo testInfo) throws Exception {
        try {
            // Neteja els clients globals i afegeix clients inicials
            Exercici0.clients.clear();
    ...
    @Test
    public void testLlistarClients(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testGeneraClauOperacio(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testAfegirOperacio(TestInfo testInfo) throws Exception {
        try {
            // Neteja la llista global d'operacions
            Exercici0.operacions.clear();
    ...
    @Test
    public void testModificarOperacio(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testEsborrarOperacio(TestInfo testInfo) throws Exception {
        try {
            // Inicialitza la llista d'operacions
            Exercici0.operacions.clear();
    ...
    @Test
    public void testLlistarOperacions(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testLlistarOperacionsClient(TestInfo testInfo) throws Exception {
        try {
            // Neteja i inicialitza la llista global d'operacions
            Exercici0.operacions.clear();
    ...
    @Test
    public void testAlineaColumnes(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testTaulaOperacionsClient0(TestInfo testInfo) throws Exception {
...
Impostos:  21% (85.05)                    Total: 490.05
    ...
    @Test
    public void testTaulaOperacionsClient1(TestInfo testInfo) throws Exception {
        Locale defaultLocale = Locale.getDefault();
        try {
            Locale.setDefault(Locale.US);
            // Inicialitza els clients
...
Impostos:  21% (473.73)                  Total: 2729.58
    ...
    @Test
    public void testTaulaOperacionsClient2(TestInfo testInfo) throws Exception {
        Locale defaultLocale = Locale.getDefault();
        try {
            Locale.setDefault(Locale.US);
            // Inicialitza els clients
...
Impostos:  21% (14.41)                     Total: 83.04
    ...
    @Test
    public void testGetCadenesMenu(TestInfo testInfo) throws Exception {
        try {
            // Menú esperat
            String menuText = """
...
0. Sortir
        ...
        @Test
        public void testObtenirOpcio(TestInfo testInfo) throws Exception {
            try {
                Object[][] tests = {
                    {"1\n", "Afegir client"},
                    {"2\n", "Modificar client"},
    ...
    @Test
    public void testLlistarClientsMenu(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testDibuixarLlista(TestInfo testInfo) throws Exception {
    ...
    @Test
    public void testLlegirNom(TestInfo testInfo) throws Exception {
        Object[][] testCases = {
            {"Joan\n", "Joan"},
            {"123\nAnna\n", "Anna"},
            {"Ayoub Martorell\n", "Ayoub Martorell"},
    ...
    @Test
    public void testLlegirEdat(TestInfo testInfo) throws Exception {
        Object[][] testCases = {
            {"25\n", 25},
    ...
    @Test
    public void testLlegirFactors(TestInfo testInfo) throws Exception {
        Object[][] testCases = {
    ...
    @Test
    public void testLlegirDescompte(TestInfo testInfo) throws Exception {
        Object[][] testCases = {
    ...
    @Test
    public void testAfegirClientMenu(TestInfo testInfo) throws Exception {
    ...
    @Test
    public void testModificarClientMenu(TestInfo testInfo) throws Exception {
    ...
    @Test
    public void testEsborrarClientMenu(TestInfo testInfo) throws Exception {
        // Configura els clients globals per tenir dades inicials
        Exercici0.clients.clear();
        HashMap<String, Object> client1 = new HashMap<>();
        client1.put("nom", "Joan");
