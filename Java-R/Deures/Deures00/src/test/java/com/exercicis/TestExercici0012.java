...
class TestExercici0012 {
    ...
    @Test
    public void testCreateWonder(TestInfo testInfo) throws Exception {
      try {
    ...
    @Test
    public void testSortWondersByName(TestInfo testInfo) throws Exception {
      try {
    ...
    @Test
    public void testGetSortedWondersByName(TestInfo testInfo) throws Exception {
      try {
          ArrayList<HashMap<String, Object>> wonders = new ArrayList<>();
          wonders.add(Exercici0012.createWonder("C Wonder", "Location C", 100));
          wonders.add(Exercici0012.createWonder("A Wonder", "Location A", 200));
    ...
    @Test
    public void testSortNames(TestInfo testInfo) throws Exception {
      try {
          ArrayList<HashMap<String, Object>> wonders = new ArrayList<>();
          wonders.add(Exercici0012.createWonder("C Wonder", "Location C", 100));
          wonders.add(Exercici0012.createWonder("A Wonder", "Location A", 200));
    ...
    @Test
    public void testGetOlder(TestInfo testInfo) throws Exception {
      try {
          ArrayList<HashMap<String, Object>> wonders = new ArrayList<>();
    ...
    @Test
    public void testGetRegion(TestInfo testInfo) throws Exception {
      try {
          ArrayList<HashMap<String, Object>> wonders = new ArrayList<>();
