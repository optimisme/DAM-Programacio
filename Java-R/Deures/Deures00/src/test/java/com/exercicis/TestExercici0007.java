...
class TestExercici0007 {
    ...
    @Test
    public void testCalculaCostLloc(TestInfo testInfo) throws Exception {
        try {
    ...
    @Test
    public void testCalculaCostMenjar(TestInfo testInfo) throws Exception {
        try {
            String diff = TestStringUtils.findFirstDifference(
    ...
    @Test
    public void testCalculaCostEntreteniment(TestInfo testInfo) throws Exception {
        try {
            String diff = TestStringUtils.findFirstDifference(
    ...
    @Test
    public void testCalculaFesta(TestInfo testInfo) throws Exception {
        try {
            String diff = TestStringUtils.findFirstDifference(
